...
\title{A Devil's Attraction} % Book title
...
\ThisCenterWallPaper{1.0}{} % Add the background image, the first argument is the scaling - adjust this as necessary so the image fits the entire page
